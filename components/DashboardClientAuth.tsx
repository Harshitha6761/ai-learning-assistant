        ...
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4 sm:px-6">
          ...
          <nav className="flex items-center gap-2 sm:gap-4">
            ...
            <form action="/api/auth/signout" method="post">
              <button type="submit" className="rounded-lg px-3 py-1.5 text-sm font-medium text-slate-600 hover:bg-slate-100 hover:text-slate-900 transition-colors">Sign out</button>
            </form>
          </nav>
        </div>
